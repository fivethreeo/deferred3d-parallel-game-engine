...
#include <d3d/rendering/texture/Texture2DArray.h>
...
namespace d3d {
	...
	public:
		...
		void generate(void(*generator)(d3d::VoxelChunk &chunk, int seed), int seed, SceneObjectPhysicsWorld* pPhysicsWorld = nullptr, float restitution = 0.0f, float friction = 1.0f);
