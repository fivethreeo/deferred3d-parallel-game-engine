#include <d3d/rendering/voxel/TerrainGenerator.h>
...
#include <d3d/constructs/Planef.h>

#include <d3d/util/NoiseGenerator.h>

#include <d3d/util/Math.h>

using namespace d3d;

void d3d::terrainGenerator0(VoxelChunk &chunk, int seed) {
	...
	//d3d::SceneObjectRef lighting = chunk.getScene()->getNamed("lighting");
...
void d3d::terrainGeneratorFlatlands(VoxelChunk &chunk, int seed) {
	NoiseGenerator generator;
	generator._seed = seed;
