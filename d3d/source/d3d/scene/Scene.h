...
#include <d3d/scene/State.h>

#include <d3d/assetmanager/AssetManager.h>

#include <d3d/rendering/Camera.h>
#include <d3d/rendering/octree/DynamicOctree.h>

#include <d3d/system/ThreadPool.h>
...
namespace d3d {
	...
	public:
		...
		ComputeSystem _computeSystem;

		Scene()
			: _logicMask(0xffff), _renderMask(0xffff)
		{}

		virtual ~Scene();

		void createScene(size_t numWorkers, const AABB3D &rootRegion, ComputeSystem::DeviceType computeDeviceType);
