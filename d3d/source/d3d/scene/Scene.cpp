...
void Scene::createScene(size_t numWorkers, const AABB3D &rootRegion, ComputeSystem::DeviceType computeDeviceType) {
	...
	_computeSystem.create(computeDeviceType, false);
}
