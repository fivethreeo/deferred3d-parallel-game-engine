...
void main() {
	...
	vec4 corner0 = d3dProjectionViewModel * vec4(world0, 1.0);
    vec4 corner1 = d3dProjectionViewModel * vec4(world1, 1.0);
    vec4 corner2 = d3dProjectionViewModel * vec4(world2, 1.0);
    vec4 corner3 = d3dProjectionViewModel * vec4(world3, 1.0);
    vec4 corner4 = d3dProjectionViewModel * vec4(world4, 1.0);
    vec4 corner5 = d3dProjectionViewModel * vec4(world5, 1.0);
    vec4 corner6 = d3dProjectionViewModel * vec4(world6, 1.0);
    vec4 corner7 = d3dProjectionViewModel * vec4(world7, 1.0);

	vec3 view0 = (d3dViewModel * vec4(world0, 1.0)).xyz;
    vec3 view1 = (d3dViewModel * vec4(world1, 1.0)).xyz;
    vec3 view2 = (d3dViewModel * vec4(world2, 1.0)).xyz;
    vec3 view3 = (d3dViewModel * vec4(world3, 1.0)).xyz;
    vec3 view4 = (d3dViewModel * vec4(world4, 1.0)).xyz;
    vec3 view5 = (d3dViewModel * vec4(world5, 1.0)).xyz;
    vec3 view6 = (d3dViewModel * vec4(world6, 1.0)).xyz;
    vec3 view7 = (d3dViewModel * vec4(world7, 1.0)).xyz;
 
    viewNormal = d3dNormal * rotatePoint(cubeNormals[0], rotationToGeom[0]);
	viewPosition = view0;
    gl_Position = corner0;
    EmitVertex();
	viewPosition = view1;
	...
	viewNormal = d3dNormal * rotatePoint(cubeNormals[1], rotationToGeom[0]);
	viewPosition = view5;
    gl_Position = corner5;
    EmitVertex();
	viewPosition = view4;
    ...
    viewNormal = d3dNormal * rotatePoint(cubeNormals[2], rotationToGeom[0]);
	viewPosition = view4;
    gl_Position = corner4;
    EmitVertex();
	viewPosition = view0;
    ...
    viewNormal = d3dNormal * rotatePoint(cubeNormals[3], rotationToGeom[0]);
	viewPosition = view1;
    gl_Position = corner1;
    EmitVertex();
	viewPosition = view5;
    ...
    viewNormal = d3dNormal * rotatePoint(cubeNormals[4], rotationToGeom[0]);
	viewPosition = view4;
    gl_Position = corner4;
    EmitVertex();
	viewPosition = view5;
    ...
    viewNormal = d3dNormal * rotatePoint(cubeNormals[5], rotationToGeom[0]);
	viewPosition = view3;
    gl_Position = corner3;
    EmitVertex();
	viewPosition = view2;
